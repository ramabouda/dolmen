...
var Dajaxice = {
    ...
    mark_read_report: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.mark_read_report', 'POST', callback_function, argv, custom_settings);
    },

    change_tribe_name: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.change_tribe_name', 'POST', callback_function, argv, custom_settings);
    },

    change_village_name: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.change_village_name', 'POST', callback_function, argv, custom_settings);
    },

    mark_unread_report: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.mark_unread_report', 'POST', callback_function, argv, custom_settings);
    },

    mission_request: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.mission_request', 'POST', callback_function, argv, custom_settings);
    },

    tile_details_request: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.tile_details_request', 'POST', callback_function, argv, custom_settings);
    },

    delete_report: function(callback_function, argv, custom_settings){
        return Dajaxice.call('game.delete_report', 'POST', callback_function, argv, custom_settings);
    }
